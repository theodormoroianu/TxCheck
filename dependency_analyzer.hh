...
struct dependency_analyzer
{
    ...
    /**
     * Returns true if the predicate of statement a is overwriten by the statement b.
     *
     * @param a_predicate_match The predicate of the statement a.
     * @param a_vsr_begin The begin of the version set read of the statement a.
     * @param a_vsr_end The end of the version set read of the statement a.
     * @param b_awr_stmt The after-write-read of statement b.
     * @param b_bpm_stmt The before-predicate-match of statement b.
     * @param b_bpm_stmt The before-predicate-match of statement b.
     * @param b_apm_stmt The after-predicate-match of statement b.
     */
    bool check_if_stmt_is_overwriten(int a_predicate_match, int a_vsr_begin, int a_vsr_end, int b_awr_stmt, int b_bpm_stmt, int b_apm_stmt);
