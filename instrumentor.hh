...
enum stmt_basic_type
{
    ...
    INSERT_WRITE,
    DELETE_WRITE,
    BEFORE_WRITE_READ,      // before
    AFTER_WRITE_READ,       // after
    VERSION_SET_READ,       // before
    BEFORE_PREDICATE_MATCH, // before
    AFTER_PREDICATE_MATCH,  // after
    PREDICATE_MATCH         // before
};
 ...
 * instrumented statement, and false otherwise.
 */
